...
public class PauseBox extends VBox{
    public PauseBox(GameCtrl gameCtrl) {
        super(10);
        boolean isTourist = gameCtrl.isTourist();
        Button restartBtn = new Button("Restart"), saveBtn = new Button("Save"), continueBtn = new Button("Continue"), exitToMenuBtn = new Button("Level Select"), exitBtn = new Button("Exit");
